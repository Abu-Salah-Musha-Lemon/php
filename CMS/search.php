...
<div id="templatemo_content_wrapper">
    ...
    <div id="templatemo_content">
        ...
        if (isset($_POST['search'])) {
           ...
           echo $searchQuery = "SELECT post_table.`Post_ID`, post_table.`Post_Title`, post_table.`Post_Description`, post_table.`Post_Date`, post_table.`Post_Image`,  post_table.`Category`, post_table.`Author`, categorytable.CategoryName, `usertable`.`userName` FROM post_table LEFT JOIN categorytable ON post_table.`category`= categorytable.Category_ID LEFT JOIN usertable ON `post_table`.`Author` = usertable.userId   post_table.Post_ID  WHERE `Post_ID`= '$search' or `Post_Title`= '$search' or `Post_Description` = '$search' ORDER BY DESC LIMIT {$limit}";
