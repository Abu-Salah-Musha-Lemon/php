                        ...
                        <div class="card shadow-2-strong" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                ...
                                <div class="form-group">
                                    <input type="hidden" class="form-control shadow-none" name="edit_post" value="<?php echo $post_id; ?>"
                                        >
                                </div>
                                <div class="form-group">
                                    <label>Post Title</label>
                                    <input type="text" class="form-control shadow-none" name="post-title"
                                        value="<?php echo $row['Post_Title']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Description</label>
                                    <input type="text-area" class="form-control shadow-none" name="Desc"
                                ...
                                <div class="form-group">
                                    <img class="my-2" style="width:150px;height:100px;"src="upload/<?php echo $row['Post_Image']; ?>">
